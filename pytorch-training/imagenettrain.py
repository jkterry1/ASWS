...
def main_worker(gpu, ngpus_per_node, args):
    ...
    outputfilename = str(model_name) + "_imagenetrun_" + str(run_num) + ".txt"
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_acc1, total_train_loss = train(train_loader, model, criterion, optimizer, epoch, args)

        # evaluate on validation set
        acc1, total_test_loss = validate(val_loader, model, criterion, args)
